...
Open the rendered helper page: [copy instagram follow back checker](https://raw.githack.com/dongt10/insta-follow-checker/main/copy.html?v=4929bd2).
...
4. Open the [copy helper](https://raw.githack.com/dongt10/insta-follow-checker/main/copy.html?v=4929bd2) and click **copy script**, or paste the script from [src/check-follow-back.js](src/check-follow-back.js).
5. Press Enter.
...
If you prefer a bookmarklet, copy it from the [copy helper](https://raw.githack.com/dongt10/insta-follow-checker/main/copy.html?v=4929bd2) or use the one-line version in [bookmarklet.js](bookmarklet.js).
